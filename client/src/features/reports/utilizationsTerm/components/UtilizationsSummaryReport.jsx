    ...
    <article ref={componentToPrintRef} className="forPrint text-grey-100">
      ...
      <footer className="mt-16 flex items-start px-8">
        <div className="flex w-full flex-col justify-end">
          <p>Prepared by:</p>
          <div className="mt-14">
            {currentUser.esignURL === null ? (
              <p className="h-14"></p>
            ) : (
              <img
                src={import.meta.env.VITE_LOCAL_BASE_URL + currentUser.esignURL}
                className="h-14 w-24 object-contain object-bottom"
                alt="esign"
              />
            )}
            <h2 className="-mb-1 mt-2 text-lg font-bold">
        ...
        <div className="flex w-full flex-col justify-end">
          ...
          <div className="mt-14">
            <img
              ...
              alt="esign"
            />
            <h2 className="-mb-1 mt-2 text-lg font-bold">Arnel Ang</h2>
            <p>LMO - Supervisor</p>
          </div>
        </div>
      </footer>
